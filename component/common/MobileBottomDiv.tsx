        ...
        >
            <div className="flex items-center w-full h-18 text-sm font-medium text-[#09273A]">
                <a
                    ...
                    className="flex gap-1.5 items-center justify-center  font-sora w-[35%] h-10 bg-[#09273A] rounded-l-full text-white p-2 rounded-md hover:bg-[#0056b3]">
                    <svg width="18" height="18" viewBox="0 0 43 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M11.5 11.5L17.384 14.9789C20.8144 17.007 22.1856 17.007 25.616 14.9789L31.5 11.5" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M31.5 34.5C32.4831 35.5114 35.0995 39.5 36.5 39.5M41.5 34.5C40.5169 35.5114 37.9005 39.5 36.5 39.5M36.5 39.5V23.5" stroke="#ffffff" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                ...
                <a
                    ...
                    className="flex gap-1.5 items-center justify-center  font-sora w-[35%] h-10 bg-[#28a745] text-white p-2 hover:bg-[#1e7e34] rounded-r-full">
