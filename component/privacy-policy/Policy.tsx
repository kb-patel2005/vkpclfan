...
const sections = [
...

    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                <path d="M2 0H12C13.1 0 14 .9 14 2V12C14 13.1 13.1 14 12 14H2C.9 14 0 13.1 0 12V2C0 .9.9 0 2 0ZM3 3V4.5H11V3H3ZM3 6V7.5H8V6H3ZM3 9V10.5H10V9H3Z" fill="#44474D" />
            </svg>
        ),
    },
...

    {
        ...
        icon: (
            ...
            >
                <path
                    d="M10 2.5V4.5M10 15.5V17.5M2.5 10H4.5M15.5 10H17.5"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                />
...

    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                <path d="M7 0L1.5 2V6.2C1.5 9.7 3.85 12.95 7 14C10.15 12.95 12.5 9.7 12.5 6.2V2L7 0ZM6.2 9.7L3.9 7.4L4.95 6.35L6.2 7.6L9.05 4.75L10.1 5.8L6.2 9.7Z" fill="#44474D" />
            </svg>
        ),
    },

    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                <path d="M7 7C8.93 7 10.5 5.43 10.5 3.5C10.5 1.57 8.93 0 7 0C5.07 0 3.5 1.57 3.5 3.5C3.5 5.43 5.07 7 7 7ZM7 8.75C4.66 8.75 0 9.92 0 12.25V14H14V12.25C14 9.92 9.34 8.75 7 8.75Z" fill="#44474D" />
            </svg>
        ),
    },
...

    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                <path d="M8 1H13V6H11.5V3.56L6.53 8.53L5.47 7.47L10.44 2.5H8V1ZM2 2.5H6V4H3.5V10.5H10V8H11.5V11C11.5 11.55 11.05 12 10.5 12H2.5C1.95 12 1.5 11.55 1.5 11V3.5C1.5 2.95 1.95 2.5 2.5 2.5H2Z" fill="#44474D" />
            </svg>
        ),
    },

    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                <path d="M7 1V0L9.5 2.5L7 5V4C4.79 4 3 5.79 3 8C3 8.71 3.19 9.38 3.53 9.96L2.44 11.05C1.86 10.17 1.5 9.12 1.5 8C1.5 4.96 3.96 2.5 7 2.5V1ZM11.56 2.95C12.14 3.83 12.5 4.88 12.5 6C12.5 9.04 10.04 11.5 7 11.5V13L4.5 10.5L7 8V9.5C9.21 9.5 11 7.71 11 5.5C11 4.79 10.81 4.12 10.47 3.54L11.56 2.95Z" fill="#44474D" />
            </svg>
        ),
    },

    {
        ...
        icon: (
            <svg width="18" height="18" viewBox="0 0 14 14" fill="none">
                <path d="M1 2C.45 2 0 2.45 0 3V11C0 11.55.45 12 1 12H13C13.55 12 14 11.55 14 11V3C14 2.45 13.55 2 13 2H1ZM1.5 3.5H12.5L7 7.25L1.5 3.5ZM1.5 10.5V5.25L7 9L12.5 5.25V10.5H1.5Z" fill="#44474D" />
            </svg>
        ),
    },
]
const para = "This privacy report details the strict protocols and transparent methodologies\n floent Technologies employs to safeguard digital assets and personal data\n architecture."

const darkSecuritt = "We implement reasonable security measures to protect your personal data from unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the internet or electronic storage is 100% secure, and we cannot guarantee absolute security."
    ...
    return (
        <section className="lg:px-0 px-5 my-15">
            <motion.div
                ...
                {/* LEFT SIDEBAR */}
                <aside className="w-full hidden lg:block lg:max-w-[300px] border-b lg:border-b-0 lg:border-l-2 h-fit border-[#C5C6CE] pt-4 pb-4 lg:pb-0 sticky lg:top-24 bg-[#F8F9FA] z-20">

                    <h1 className="pl-4 font-inter font-bold text-[28px] leading-[36px] tracking-[0px] align-middle text-[#44474D]">
                ...
                {/* RIGHT CONTENT */}
                <main className="flex flex-col gap-4 w-full lg:mb-20">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-10">
                            <div>
                                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 lg:gap-6">
                                    <h2 className="font-sora font-bold text-[42px] sm:text-[56px] lg:text-[96px] leading-[1.05] lg:leading-[120px] tracking-[-1px] lg:tracking-[-4.8px] align-middle text-[#44474D]">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="font-normal text-[16px] leading-[28px] tracking-[0px] text-[#1B1B1D]">
                            We are committed to ensuring that our website and services are accessible to everyone, including individuals with disabilities. We will make reasonable efforts to ensure that our data protection practices comply with the DPDA and provide accessible and inclusive digital experiences.
                        </p>
                                ...
                                <div className="space-y-4">
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            <span className="font-bold">Personal Identification Information: </span>{" "}Name, email address, phone number, and any other information you voluntarily provide when you register on our Site or contact us.
                                        </p>
                                    ...
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            <span className="font-bold">Transactional Data: </span>{" "}  Information about purchases, orders, or other transactions you conduct through our Site. </p>
                                    </div>
                                    <div className="relative  pl-4">
                                        <div className="absolute h-6 w-1 top-0 left-0 bg-[#2C7BE5]"></div>

                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            <span className="font-bold">Usage Data:  </span>{" "}   Details of how you use our Site, including IP address, browser type, operating system, pages visited, and the time and date of your visit.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="lg:col-span-9 p-6 sm:p-8 lg:p-12 flex flex-col gap-6 bg-white border border-[#5D5D5D]">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            Enhance the user experience on our Site.
                                        </p>
                                    </div>
                                    <div className="relative  pl-4">
                                        <div className="absolute h-6 w-1 top-0 left-0 bg-[#2C7BE5]"></div>
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            Analyze usage trends to improve our Site’s functionality.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        <div className="grid lg:grid-cols-12 gap-8">
                            <div className="lg:col-span-3 flex flex-col gap-4">
                                ...
                                <h3 className="font-inter font-bold text-[28px] leading-[36px] tracking-[0px] align-middle text-[#071A33]">
                                    Sharing of <br />Your Information
                                </h3>
                                ...
                                <div className="space-y-4">
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            ...
                                            We may share information with third-party vendors who perform services on our behalf, such as payment processors or email service providers. These providers are contractually obligated to protect your data and use it only for the purposes for which it was shared.
                                        </p>
                                    ...
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            ...
                                            We may disclose your information if required by law, regulation, or legal process, or in response to requests from government authorities.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="space-y-4">
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            ...
                                            {" "}We use Google Analytics to track and analyze website traffic and user behavior. Google Analytics collects information about your visit, including your IP address, browser type, and pages visited. This helps us understand how users interact with our Site and improve our services.     </p>
                                    ...
                                    <div className="relative  pl-4">
                                        ...
                                        <p className="font-inter text-[16px] leading-[28px] tracking-[0px] align-middle text-[#071A33]">
                                            <span className="font-bold">Microsoft Clarity: </span>{" "}
                                            We use Microsoft Clarity to gain insights into user interactions on our Site. Microsoft Clarity provides us with data on user behavior, including click patterns and session recordings, which helps us enhance the user experience.
                                        </p>
                                    </div>
                    ...
                    >
                        <div className="relative bg-[#07263A] p-6 sm:p-8 lg:p-[64px] overflow-hidden">
                            <div className="flex flex-col gap-4">
                                ...
                                <h3 className="font-bold text-[36px] leading-[44px] tracking-[-0.36px] align-middle text-white">
                    ...
                    >
                        ...
                        <h3 className="font-bold text-[28px] leading-9 pt-4 text-[#071A33] mt-4">
                            User Rights
                        </h3>
                    ...
                    >
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                            <div className="flex flex-col gap-4 w-full lg:w-1/2 min-w-[250px]">
                                ...
                                <h3 className="font-bold text-[36px] leading-[44px] tracking-[-0.36px] align-middle text-[#071A33]">
                                    Contact Us
                                </h3>
